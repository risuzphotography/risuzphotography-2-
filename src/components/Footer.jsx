...
return ( <footer className="site-footer"> <div className="container footer-grid"> <div className="footer-brand"> <div className="footer-logo"> <img
           src="/logo.jpg"
        ...
        <div>
          ...
          <p>
            Capturing weddings, portraits, events, and timeless memories
            with a cinematic and elegant photography style.
          </p>
        </div>
      </div>
    </div>
